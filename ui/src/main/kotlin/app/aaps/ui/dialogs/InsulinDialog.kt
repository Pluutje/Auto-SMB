...
class InsulinDialog : DialogFragmentWithDate() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // binding.activeerExtraInsuline.setOnCheckedChangeListener { _, isChecked: Boolean ->
        //    binding.tijdLayout.visibility = isChecked.toVisibility()
        //    binding.percentageLayout.visibility = isChecked.toVisibility()
        // }
        binding.tijdbasaalLayout.visibility = View.VISIBLE
        binding.uitgesteldbasaalLayout.visibility = View.VISIBLE
        //    binding.bolusViaBasaal.setOnCheckedChangeListener { _, isChecked: Boolean ->
        //    binding.tijdbasaalLayout.visibility = isChecked.toVisibility()
        //    binding.uitgesteldbasaalLayout.visibility = isChecked.toVisibility()
        //  }
    ...
    override fun submit(): Boolean {
        ...
        if (extraInsulineChecked){
            file.writeText("checked" + "\n" + tijdNu + "\n" + tijdExtraInsuline + "\n" + percentageExtraInsuline)
        } else {
            file.writeText("unchecked" + "\n" + tijdNu + "\n" + tijdExtraInsuline + "\n" + percentageExtraInsuline)
        }
        if (StopBolusChecked) {
            file.writeText("unchecked" + "\n" + tijdNu + "\n" + tijdExtraInsuline + "\n" + percentageExtraInsuline)
        }
        ...
        //     file.writeText("unchecked" + "\n" + tijdNu + "\n" + tijdExtraInsuline + "\n" + percentageExtraInsuline)
        //  } else {
        //     if (insulin == 0.0 && !alleenBoostChecked)  {
        //       file.writeText("unchecked" + "\n" + tijdNu + "\n" + tijdExtraInsuline + "\n" + percentageExtraInsuline)
        //     } else {
        //       file.writeText("checked" + "\n" + tijdNu + "\n" + tijdExtraInsuline + "\n" + percentageExtraInsuline)
        //     }
        ...
        if (bolusviabasaalChecked && insulin > 0.0) {
            ...
            // filebasaal.createNewFile()
            filebasaal.writeText("checked" + "\n" + tijdNu + "\n" + tijdbolusbasaal + "\n" + insuline)
        } else {
            filebasaal.writeText("unchecked" + "\n" + tijdNu + "\n" + tijdbolusbasaal + "\n" + insuline)
        }

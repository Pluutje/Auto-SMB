...
open class OpenAPSSMBPlugin @Inject constructor(
    ...
    override fun invoke(initiator: String, tempBasalFallback: Boolean) {
        ...
        val oapsProfile = OapsProfile(
            ...
            PersistentDrempel = preferences.get(DoubleKey.persistent_drempel),
            PersistentGrens = preferences.get(DoubleKey.persistent_grens),
            lowCarbPrebolus = preferences.get(DoubleKey.lowCarbPrebolus),
            lowCarbPerc = preferences.get(IntKey.lowCarbPerc),
            mediumCarbPrebolus = preferences.get(DoubleKey.mediumCarbPrebolus),
            mediumCarbPerc = preferences.get(IntKey.mediumCarbPerc),
            highCarbPrebolus = preferences.get(DoubleKey.highCarbPrebolus),
            highCarbPerc = preferences.get(IntKey.highCarbPerc),
            ...
            newuamhypoPerc = preferences.get(IntKey.new_uam_hypoPerc),
    ...
    override fun addPreferenceScreen(preferenceManager: PreferenceManager, parent: PreferenceScreen, context: Context, requiredKey: String?) {
        ...
        category.apply {
            ...
            addPreference(preferenceManager.createPreferenceScreen(context).apply {
                key = "Info tbv algoritme"
                title = "Info tbv algoritme"
                addPreference(
                    AdaptiveIntentPreference(
                        ctx = context,
                        intentKey = IntentKey.ApsLinkToDocs,
                        intent = Intent().apply { action = Intent.ACTION_VIEW; data = Uri.parse(rh.gs(R.string.www_doc1)) },
            ...
            addPreference(preferenceManager.createPreferenceScreen(context).apply {
                key = "Persistent hoge BG instelling"
                title = "Persistent hoge BG instelling"
                addPreference(
                    AdaptiveIntentPreference(
                        ctx = context,
                        intentKey = IntentKey.ApsLinkToDocs,
                ...
                addPreference(AdaptiveDoublePreference(ctx = context, doubleKey = DoubleKey.persistent_drempel, dialogMessage = R.string.persistent_drempel_summary, title = R.string.persistent_drempel_title))
            ...
            addPreference(preferenceManager.createPreferenceScreen(context).apply {
                ...
                title = "UAM Boost instelling"
                addPreference(
                    AdaptiveIntentPreference(
                        ctx = context,
                        intentKey = IntentKey.ApsLinkToDocs,
                        intent = Intent().apply { action = Intent.ACTION_VIEW; data = Uri.parse(rh.gs(R.string.www_new_UAMBoost)) },
                        summary = R.string.Info_new_UAMBoost
                    )
                )
                ...
                addPreference(AdaptiveIntPreference(ctx = context, intKey = IntKey.new_uam_hypoPerc, dialogMessage = R.string.new_UAMhypoPerc_summary, title = R.string.new_UAMhypoPerc_title))
            })
            addPreference(preferenceManager.createPreferenceScreen(context).apply {
            ...
            addPreference(preferenceManager.createPreferenceScreen(context).apply {
                ...
                addPreference(preferenceManager.createPreferenceScreen(context).apply {
                    key = "mode_boost_tijd"
                    title = "looptijd correctie settings"

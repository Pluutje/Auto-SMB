...
enum class DoubleKey(
    ...
    persistent_drempel("persistent_drempel", 10.0,7.0,14.0),
    persistent_grens("persistent_grens",0.5,0.1, 1.0),
    lowCarbPrebolus("lowCarbPrebolus",1.5,0.5, 5.0),
    mediumCarbPrebolus("mediumCarbPrebolus",2.5,0.5, 5.0),
    highCarbPrebolus("highCarbPrebolus",3.5,0.5, 5.0),

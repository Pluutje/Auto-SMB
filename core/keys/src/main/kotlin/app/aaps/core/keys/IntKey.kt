...
enum class IntKey(
    ...
    lowCarbPerc("lowCarbPerc",225,50, 500),
    mediumCarbPerc("mediumCarbPerc",225,50, 500),
    highCarbPerc("highCarbPerc",225,50, 500),
    BoostPerc("highCarbPerc",225,50, 500),
    maxBoostPerc("maxBoostPerc",400,100, 750),
    new_uam_boostPerc("new_uam_boostPerc", 200,100,350),
    new_uam_hypoPerc("new_uam_hypoPerc", 50,10,100),

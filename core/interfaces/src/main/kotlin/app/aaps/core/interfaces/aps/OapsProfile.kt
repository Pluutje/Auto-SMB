...
data class OapsProfile(
    ...
    var PersistentDrempel: Double,
    var PersistentGrens: Double,
    var lowCarbPrebolus: Double,
    var lowCarbPerc: Int,
    var mediumCarbPrebolus: Double,
    var mediumCarbPerc: Int,
    var highCarbPrebolus: Double,
    var highCarbPerc: Int,
    var BoostPerc: Int,
    var maxBoostPerc: Int,
    var Stappen: Boolean,
    var newuamboostDrempel: Double,
    var newuamboostPerc: Int,
    var newuamhypoPerc: Int,
